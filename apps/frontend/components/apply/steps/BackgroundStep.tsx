  ...
  return (
    <div>
      ...
      <div className="mt-8 flex items-baseline justify-between border-t border-line pt-6">
        <span className="text-mono-label text-ink-3">WORK EXPERIENCE</span>
      ...
      <div className="mt-8 flex items-baseline justify-between border-t border-line pt-6">
        <span className="text-mono-label text-ink-3">EDUCATION &amp; QUALIFICATIONS</span>
      ...
      <StepActions onBack={onBack} onNext={onNext} nextLabel="Next: Services" nextDisabled={!canContinue} />
    </div>
  );
}
